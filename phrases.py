...
sample_phrase = "NYEL JX WNL WNJGA SJWN TLFWNLIX WNFW ELIUNLX JG WNL XYBH FGP XJGAX WNL WBGL SJWNYBW WNL SYIPX FGP GLMLI XWYEX FW FHH LCJHQ PJURJGXYG"

sample_key = {"S":"W"}
Sample = " ".join(sample_phrase.split(" ")[:-2]),sample_key
